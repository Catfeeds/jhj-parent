...
public class PhoneRechargeChartController extends BaseController {
	
	@Autowired
	private PhoneRechargeChartService chartService;
	
	/*
	 * 话费订单  (数量) 图表
	 */
	@AuthPassport
	@RequestMapping(value = "phoneRechargeOrder",method = RequestMethod.GET)
...
//		ChartSearchVo chartSearchVo = new ChartSearchVo();
		...
		ChartDataVo chartDatas = chartService.getPhoneOrder(chartSearchVo, timeSeries);
		model.addAttribute("chartDatas", chartDatas);
		return "chart/chartPhoneRecharge";
	}
	 ...
	 */
	@AuthPassport
	@RequestMapping(value = "phoneRechargeRevenue",method = RequestMethod.GET)
	public String chartOrderRevenue(HttpServletRequest request, ChartSearchVo chartSearchVo,Model model){
...
//		ChartSearchVo chartSearchVo = new ChartSearchVo();
		...
		//根据statType 和 开始结束时间，统计数据
		ChartDataVo chartDatas = chartService.getPhoneRevenue(chartSearchVo, timeSeries);
		model.addAttribute("chartDatas", chartDatas);
		return "chart/chartPhoneRechargeRevenue";
	}
