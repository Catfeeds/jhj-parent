	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="panel-body">
				<form:form modelAttribute="partnerFormModel" class="form-horizontal"
					method="POST" action="partner_type_form" 
					enctype="multipart/form-data">

					<!-- 真正的serviceTypeId -->
					<input type="hidden" value="${partnerFormModel.serviceTypeId }" name="flagServiceTypeId">
					
					<div class="form-body">
						<div class="form-group required">

							<!-- 父级服务id -->
							<label class="col-md-2 control-label">父级服务</label>
							<div class="col-md-5">
								<partServiceType:select selectId="${partnerFormModel.parentId }"/>
							</div>
						</div>
