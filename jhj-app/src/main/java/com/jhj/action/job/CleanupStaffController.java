...
public class CleanupStaffController extends BaseController {

	@Autowired
	private CleanupStaffService cleanupStaffService;
	...
	public AppResultData<Object> cleanupUserOrderCard(HttpServletRequest request) {
		...
		if (reqHost.equals("localhost") || reqHost.equals("127.0.0.1")) {
			cleanupStaffService.rebuildOrder();
			cleanupStaffService.rebuildStaffPayDep();
			cleanupStaffService.rebuildStaffCash();
		}
		return result;
	}
