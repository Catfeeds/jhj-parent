...
public class OrderHourDetailController extends BaseController {
	...
	public AppResultData<Object> orderHourDetail(@RequestParam("order_no") String orderNo) {
	...
	public AppResultData<Object> OrderHourPaoTui(@RequestParam("order_no") String orderNo) {

		AppResultData<Object> result = new AppResultData<Object>(Constants.SUCCESS_0, ConstantMsg.SUCCESS_0_MSG, "");

		OrderHourViewVo orderHourViewVo = orderHourDetailService.getOrderPaotui(orderNo);
	 ...
	 */
	/*
	 * @RequestMapping(value = "get_user_list_detail", method =
	 * RequestMethod.GET)
