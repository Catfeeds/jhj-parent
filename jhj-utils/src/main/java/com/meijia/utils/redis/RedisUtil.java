...
public class RedisUtil {
	...
	private void initJedisPool() {
		ResourceBundle properties =  RedisConfigUtil.getInstance().getRb();

		JedisPoolConfig config = new JedisPoolConfig();
		config.setMaxIdle(Integer.valueOf(properties.getString("redis.pool.maxIdle")));
		config.setTestOnBorrow(Boolean.getBoolean(properties.getString("redis.pool.testOnBorrow")));
		config.setTestOnReturn(Boolean.getBoolean(properties.getString("redis.pool.testOnReturn")));
		jedisPool = new JedisPool(config, properties.getString("redis.ip"), Integer.valueOf(properties.getString("redis.port")));
	}
