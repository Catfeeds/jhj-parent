...
<body>
	<section id="container"> <%@ include file="../../shared/pageHeader.jsp"%> <%@ include
		file="../../shared/sidebarMenu.jsp"%> <section id="main-content"> <section
		class="wrapper">
	<div class="row">
		<div class="col-lg-12">
			<section class="panel"> <header class="panel-heading"> 服务类别管理 </header>
			<hr style="width: 100%; color: black; height: 1px; background-color: black;" />
			<form:form enctype="multipart/form-data" modelAttribute="contentModelForm" class="form-horizontal" method="POST"
				id="service-form">
				<div class="form-body">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="form-group required">
								<label class="col-md-5 control-label">非会员价(加时)*</label>
								<div class="col-md-3">
							...
							<div class="form-group required">
								<label class="col-md-5 control-label">非会员价员工提成(加时)*</label>
								<div class="col-md-3">
						...
						<div class="col-md-6">
							<div class="form-group required">
								<label class="col-md-5 control-label">非会员套餐价格*</label>
								<div class="col-md-3">
							...
							<div class="form-group required">
								<label class="col-md-5 control-label">非会员价员工提成(套餐)*</label>
								<div class="col-md-3">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="form-group required">
								<label class="col-md-5 control-label">会员价(加时)*</label>
								<div class="col-md-3">
							...
							<div class="form-group required">
								<label class="col-md-5 control-label">会员价员工提成(加时)*</label>
								<div class="col-md-3">
						...
						<div class="col-md-6">
							<div class="form-group required">
								<label class="col-md-5 control-label">会员套餐价格*</label>
								<div class="col-md-3">
							...
							<div class="form-group required">
								<label class="col-md-5 control-label">会员价员工提成(套餐)*</label>
								<div class="col-md-3">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="form-group required">
								<label class="col-md-5 control-label">活动价(加时)*</label>
								<div class="col-md-3">
									<form:input path="aprice" class="form-control" placeholder="活动价" />
									<form:errors path="aprice" class="field-has-error" />
								</div>
							</div>
							<div class="form-group required">
								<label class="col-md-5 control-label">活动价员工提成(加时)*</label>
								<div class="col-md-3">
									<form:input path="staffAprice" class="form-control" placeholder="活动价员工提成" />
									<form:errors path="staffAprice" class="field-has-error" />
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group required">
								<label class="col-md-5 control-label">活动套餐价格*</label>
								<div class="col-md-3">
									<form:input path="apprice" class="form-control" placeholder="活动套餐价格" />
									<form:errors path="apprice" class="field-has-error" />
								</div>
							</div>
							<div class="form-group required">
								<label class="col-md-5 control-label">活动员工提成(套餐)*</label>
								<div class="col-md-3">
									<form:input path="staffApprice" class="form-control" placeholder="活动价员工提成" />
									<form:errors path="staffApprice" class="field-has-error" />
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
							<table id="serviceAddonTable" class="table table-hover table-condensed controls">
								...
								<c:forEach items="${serviceAddons}" var="item">
									<tr class="odd gradeX">
										<td><input type="hidden" name="serviceAddonIds" value="${item.serviceAddonId}" /> <input type="text"
												name="serviceAddonName" value="${item.name}" maxLength="32" class="form-control"></td>
										<td><input type="text" name="itemUnit" value="${item.itemUnit}" maxLength="32" class="form-control"></td>
										<td><input type="text" name="serviceAddonPrice" value="${item.price}"
												onkeyup="value=value.replace(/[^\-?\d.]/g,'')" maxLength="32" class="form-control"></td>
										<td><input type="text" name="serviceAddonStaffPrice" value="${item.staffPrice}"
												onkeyup="value=value.replace(/[^\-?\d.]/g,'')" maxLength="32" class="form-control"></td>
										<td><input type="text" name="serviceAddonDisPrice" value="${item.disPrice}"
												onkeyup="value=value.replace(/[^\-?\d.]/g,'')" maxLength="32" class="form-control"></td>
										<td><input type="text" name="serviceAddonStaffDisPrice" value="${item.staffDisPrice}"
												onkeyup="value=value.replace(/[^\-?\d.]/g,'')" maxLength="32" class="form-control"></td>
												
										<td><input type="text" name="serviceAddonAprice" value="${item.aprice}"
												onkeyup="value=value.replace(/[^\-?\d.]/g,'')" maxLength="32" class="form-control"></td>
										<td><input type="text" name="serviceAddonStaffAprice" value="${item.staffAprice}"
												onkeyup="value=value.replace(/[^\-?\d.]/g,'')" maxLength="32" class="form-control"></td>		
												
										<td><input type="text" name="defaultNum" value="${item.defaultNum}"
												onkeyup="value=value.replace(/[^\-?\d.]/g,'')" maxLength="32" class="form-control"></td>
										<td><input type="text" name="serviceAddonServiceHour" value="${item.serviceHour}"
												onkeyup="value=value.replace(/[^\-?\d.]/g,'')" maxLength="32" class="form-control"></td>
					...
					<div id="weekTimes" class="form-group required">
						...
						<div class="col-md-5">
							<form:input path="serviceTimes" class="form-control" placeholder="请输入合法的数字" maxlength="10" />
					...
					<div class="form-group">
						...
						<div class="col-md-5">
							<img src="${contentModelForm.serviceImgUrl }"
								style="display: block; width: 100%; max-width: 200px; max-height: 200px;" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-2 control-label">服务类别图标</label>
						<div class="col-md-5">
							<input id="serviceImgUrl" type="file" name="serviceImgUrl" accept="image/*" data-show-upload="false">
						</div>
					</div>
					<div class="form-group">
