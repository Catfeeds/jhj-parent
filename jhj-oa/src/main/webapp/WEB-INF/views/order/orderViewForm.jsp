...
<body>
			...
			<div class="panel-body">
				<form:form modelAttribute="oaOrderListVoModel" class="form-horizontal"
					...
					<div class="form-body">
						...
						<%-- <div class="form-group " id="allStaff">
						
							<label class="col-md-2 control-label">可用阿姨</label>
							<div class="col-md-5">			
								<form:select path="staffId" items="${oaOrderListVoModel.staMap }" >
										<option value="">请选择</option>
								</form:select>				
							
								<form:radiobuttons items="${oaOrderListVoModel.staMap }" path="staffId"/>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							</div>
						</div> --%>
					...
					<hr style="width: 100%; color: black; height: 1px; background-color: black;" />
						...
						<div class="form-actions fluid">
							<div class="col-md-offset-6 col-md-6" style="margin-left: 315px">
								<button type="submit" id="viewForm" class="btn btn-success">换人</button>
							</div>
						</div>
				</form:form>
			</div>
	...
	<script type="text/javascript" src="<c:url value='/js/order/orderViewForm.js'/>"></script>
