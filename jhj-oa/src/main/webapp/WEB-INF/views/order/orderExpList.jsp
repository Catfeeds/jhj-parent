              ...
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                      	  ...
                      	  <form:form modelAttribute="oaOrderSearchVoModel" action="order-exp-list" method="GET">
                         ...
                         <!--  <button id="exportExcel" class="btn btn-success">导出Excel</button> -->
                          ...
                          <table class="table table-striped table-advance table-hover" id="table2excel">
                              ...
                              <tr>	
							       	...
							       	<td><button id="btn_update" onClick="btn_update('order/order-exp-view?orderNo=${ item.orderNo }&disStatus=${fn:substring(sta.key,0,1) }')" class="btn btn-primary btn-xs" title="订单详情"><i class=" icon-ambulance"></i></button></td>
                              </tr>
                              	</c:forEach>
                              </c:forEach>
                              </tbody>
                      ...
                      <c:import url = "../shared/paging.jsp">
	        				...
	        				<c:param name="urlAddress" value="/order/order-exp-list"/>
	       			  </c:import>
                  </div>
              </div>
              <!-- page end-->
