...
public interface OrderDispatchsService {
	...
	List<Map<String, String>> checkDispatchedToday(Long serviceTypeId, String serviceDateStr, String lat, String lng, double serviceHours, int staffNums, Short orderType);

	List<Map<String, String>> checkDispatchedDayByStaffId(Long serviceTypeId, String serviceDateStr, Long staffId, String lat, String lng, double serviceHours,
			int staffNums, Short orderType);
